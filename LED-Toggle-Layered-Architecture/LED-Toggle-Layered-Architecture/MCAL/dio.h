...
#define PC 2 //port C
#define PD 3 //port D
#define pin0 (1<<0) //pin0 of the port 
#define pin1 (1<<1) //pin1 of the port 
#define pin2 (1<<2) //pin2 of the port 
#define pin3 (1<<3) //pin3 of the port 
#define pin4 (1<<4) //pin4 of the port 
#define pin5 (1<<5) //pin5 of the port 
#define pin6 (1<<6) //pin6 of the port 
#define pin7 (1<<7) //pin7 of the port 
